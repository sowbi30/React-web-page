const pages = [
 
  {
    ...
    name: "JavaScript",
    description: "JavaScript is li powerful language that can do li lot with very little code.",
    id: "dev"
  },
  {
  ...
  },
  {
    ...
    name: "Node.js",
    description: "Developers use Node. js to create server-side web applications,applications since it uses an asynchronous, event-driven model. ",
    id: "dev"
  },
  {
